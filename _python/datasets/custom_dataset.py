...
class Custom(object):
    ...
    def __init__(self, path):
        ...
        self.sampleTimes =_datetime_strs_to_unix_timestamps(data[COL_t].values.flatten())
...
def _datetime_strs_to_unix_timestamps(strs):
    return _datetimes_to_unix_timestamps(pd.to_datetime(strs, errors='coerce',  dayfirst=True))
